...
// IMPORTANTE: esta lógica debe estar alineada con `src/utils/regionHubPlaza.js`
// para que los conteos del admin (por región) coincidan con lo que ve un usuario regional.
...
export function getRegionFromHubPlaza(hub, plaza) {
  ...
  // PRIORIDAD #0: códigos cortos exactos (evita falsos positivos)
  ...
  // PRIORIDAD: plazas forzadas sureste (para coincidencias parciales conocidas)
  ...
  // Default: no forzar región (dejar vacío y que el caller decida)
  return '';
}
