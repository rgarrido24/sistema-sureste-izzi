...
function AppContent() {
  ...
  if (role === 'admin' || role === 'admin_general' || role === 'admin_region' || role === 'director' || role === 'usuarios' || role === 'mesa_control' || role === 'regionales' || role === 'cobranza_mx' || role === 'coordinador_claves') {
